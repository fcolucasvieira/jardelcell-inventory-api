...
public class UnreserveProductUseCase {
    private final ProductRepository productRepository;
    private final ProductMapper productMapper;
    private final InventoryMovementService inventoryMovementService;

    @Transactional
    public ProductResponse execute(UUID productId, UnreserveProductRequest request) {
        ...
        inventoryMovementService.registerUnreserve(product, request.observation());
