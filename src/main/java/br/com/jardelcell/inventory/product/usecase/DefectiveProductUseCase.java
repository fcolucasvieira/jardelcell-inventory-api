...
public class DefectiveProductUseCase {
    private final ProductRepository productRepository;
    private final ProductMapper productMapper;
    private final InventoryMovementService inventoryMovementService;

    @Transactional
    public ProductResponse execute(UUID productId, DefectiveProductRequest request) {
        ...
        inventoryMovementService.registerDefective(product, request.observation());
